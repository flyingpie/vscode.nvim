...
theme.set_highlights = function(opts)
    ...
    hl(0, 'NonText', { fg = c.vscNonText or c.vscLineNumber or c.vscTabOther, bg = c.vscNone })
    ...
    hl(0, 'TabLine', { fg = c.vscTabLine or c.vscFront, bg = c.vscTabOther })
    hl(0, 'TabLineFill', { fg = c.vscTabLineFill or c.vscFront, bg = c.vscTabOutside })
    hl(0, 'TabLineSel', { fg = c.vscTabLineSel or c.vscFront, bg = c.vscTabCurrent })
    ...
    hl(0, 'Whitespace', { fg = isDark and c.vscWhitespace or c.vscTabOther })
    ...
    hl(0, 'MiniIconsBlue', { fg = c.vscMediumBlue })
    hl(0, 'MiniIconsCyan', { fg = c.vscBlueGreen })
    hl(0, 'MiniIconsGreen', { fg = c.vscGreen })
    hl(0, 'MiniIconsGrey', { fg = c.vscFront })
    hl(0, 'MiniIconsOrange', { fg = c.vscRed })
    hl(0, 'MiniIconsPurple', { fg = c.vscPink })
    hl(0, 'MiniIconsRed', { fg = c.vscRed })
    hl(0, 'MiniIconsYellow', { fg = c.vscDarkYellow })
